...
class Card(object):
    ...
    def __init__(self, value : int, suit : int):
        ...
        self.card_image = f"{self.value_r}{self.suit_img_r}.png"
    ...
    def __repr__(self):
        ...
        #self.mtracker.send_lb_message(f"Card self.r: {self.r}")
        #self.mtracker.send_lb_message(f"Value_i, Suit_i: {self.value_i},{self.suit_i}")
        # self.mtracker.send_lb_message(self.get_CardImages())
        return self.r
    ...
    def __int__(self):
        ...
        #self.mtracker.send_lb_message(f"Card self.b: {self.b}")
        return self.b
